...
const PropertyDetails = () => {
  ...
  return (
    <section>
      <div className="container mx-auto min-h-[800px] mb-14 border-2 border-green-300">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row border-2 border-blue-400">
          <div className="max-w-[768px]">
            <div className="mb-8">
              <img src={house.imageLg} alt="" />
            </div>
            <div className="flex gap-x-6 text-violet-700 mb-6 border-2 border-red-400">
